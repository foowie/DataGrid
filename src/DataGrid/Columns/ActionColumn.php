...
class ActionColumn extends Column implements \ArrayAccess
{
	...
	public function addCallbackAction($title, $linkCallback, Nette\Utils\Html $icon = NULL, $useAjax = FALSE)
	{
		$action = new DataGrid\CallbackAction($title, $linkCallback, $icon, $useAjax);
		$this[] = $action;
		return $action;
	}
