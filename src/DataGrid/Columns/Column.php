...
abstract class Column extends Nette\ComponentModel\Container implements IColumn
{
	...
	/** @var array  of callback function($value, $data) */
	...
	public function addYesNoFilter($translateItems = TRUE)
	{
		$this->_addFilter(new Filters\SelectboxFilter(array(1 => 'Yes', 0 => 'No'), true));
		return $this->getFilter()->translateItems($translateItems);
	}
